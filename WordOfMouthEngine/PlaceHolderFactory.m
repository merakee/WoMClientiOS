...
NSUInteger const PHFNumberOfLastYears = 4;
NSUInteger const PHFMinNumberOfWordsInSentence = 4;
NSUInteger const PHFMaxNumberOfWordsInSentence = 16;
NSUInteger const PHFMinNumberOfSentencesInParagraph = 3;
NSUInteger const PHFMaxNumberOfSentencesInParagraph = 9;
NSUInteger const PHFMinNumberOfWordsInTitle = 2;
NSUInteger const PHFMaxNumberOfWordsInTitle = 7;
...
+ (NSString *)sentencesWithNumber:(NSInteger)numberOfSentences
{
    ...
    for (NSInteger i = 0; i < numberOfSentences; i++) {
        NSInteger numberOfWords = LIRandomUnsignedInteger(PHFMinNumberOfWordsInSentence, PHFMaxNumberOfWordsInSentence);
...
+ (NSString *)paragraphsWithNumber:(NSInteger)numberOfParagraphs
{
    ...
    for (NSInteger i = 0; i < numberOfParagraphs; i++) {
        NSInteger numberOfSentences = LIRandomUnsignedInteger(PHFMinNumberOfSentencesInParagraph, PHFMaxNumberOfSentencesInParagraph);
...
+ (NSString *)title
{
    NSInteger number0fWords = LIRandomUnsignedInteger(PHFMinNumberOfWordsInTitle, PHFMaxNumberOfWordsInTitle);
...
+ (NSDate *)date
{
    ...
    [referenceDateComponents setYear:-PHFNumberOfLastYears];
...
{
    return [self URLForPlaceholderImageFromService:PHFPlaceholderImageServiceDefault
                                          withSize:size];
}
...
{
    return [self placeholderImageFromService:PHFPlaceholderImageServiceDefault
                                    withSize:size];
}

+ (LIImage *)placeholderImageFromService:(PHFPlaceholderImageService)service
                                withSize:(LISize)size
{
...
{
    [self asyncPlaceholderImageFromService:PHFPlaceholderImageServiceDefault
                                  withSize:size
