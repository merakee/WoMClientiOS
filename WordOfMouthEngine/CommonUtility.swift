...
class CommonUtility{
    ...
    */
    ...
    class func maxValInArray(fArray: [Float]) -> Float?  {
        if (fArray.count==0){
            return nil
        }
        return fArray.reduce(fArray[0], { max($0, $1) })
    }
    
    class func minValInArray(fArray: [Float]) -> Float?  {
        if (fArray.count==0){
            return nil
        }
        return fArray.reduce(fArray[0], { min($0, $1) })
    }
    ...
    */
    ...
    // MARK: - Legal Info
    class func getCopyRightText() -> String {
        return NSString(format:"©%d Indriam Inc.",CommonUtility.getCurrentYear())
    }
    
    class func getBrandText() -> String {
        return "A Mobkoo Product";
    }
    
    // MARK: - Font Related Methods
    class func getAllFontFamilyList() -> [AnyObject] {
    ...
    */
    ...
    // Get necessary date components
    return  NSCalendar.currentCalendar().components(.YearCalendarUnit, fromDate:NSDate()).year
    }
    ...
    */
    ...
    // MARK: - Random text, numbers and others
    /*
